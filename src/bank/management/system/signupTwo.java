...
public class signupTwo extends JFrame implements ActionListener {
    ...
    signupTwo(String formno){
        ...
        JLabel additionalDetailso=new JLabel("Page 2: Additional Details");
        additionalDetailso.setFont(new Font("Raleway",Font.BOLD,38));
        additionalDetailso.setBounds(140,20,600,40);
        add(additionalDetailso);
        ...
        JLabel gender = new JLabel("Eduactional");
        ...
        adhaar.setFont(new Font("Ralway",Font.BOLD,14));
